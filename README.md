...
启动: hexo server
浏览器打开: http://localhost:4000/https://github.com//

新加的assert可以放在public下, 访问路径为: /https://github.com//assert/

语法手册: http://localhost:4000/https://github.com//2017/08/24/Manual/
